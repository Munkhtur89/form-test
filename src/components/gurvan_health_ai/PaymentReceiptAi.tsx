...
import Up from "@/../public/qr-code.png";
import { motion } from "framer-motion";

interface PaymentReceiptAiProps {
  onFileChange: (files: File[]) => void;
}

interface PaymentReceiptAiData {
...
interface CompensationUploadedFile extends UploadedFile {
  compensationData?: PaymentReceiptAiData;
}

const PaymentReceiptAi: React.FC<PaymentReceiptAiProps> = ({
  onFileChange,
}) => {
        ...
        messages: [
          {
            ...
            content: [
              {
                type: "text",
                text: `Энэ зураг дээрх баримтыг таних хэрэгтэй. Баримт нь эмнэлгийн төлбөрийн баримт эсэх, эсвэл эмийн сангийн баримт эсэхийг тодорхойлж өгнө үү.

Хэрэв эмнэлгийн төлбөрийн баримт бол:
- Эмнэлгийн нэр (жишээ нь: "Гурван гал нэгдсэн эмнэлэг")
- Баримтын дугаар
- Хүний нэр, регистрийн дугаар, нас, хүйс
- Үйлчилгээний мэдээлэл (үйлчилгээний нэр, өрөөний дугаар, үнэ)
- Нийт дүн
- Төлбөрийн хэлбэр (бэлэн мөнгө, картаар, эмнэлгийн даатгал)
- Үйлчилсэн хүний нэр

Хэрэв эмийн сангийн баримт бол:
- Эмийн сангийн нэр
- Баримтын дугаар
- Эмийн жагсаалт, тоо ширхэг, үнэ
- Нийт дүн
- Төлбөрийн хэлбэр

Хэрэв өөр төрлийн баримт бол түүний төрлийг тодорхойлж өгнө үү.

Зөвхөн "Тийм" эсвэл "Үгүй" гэж хариулна уу.`,
              },
              {
                type: "image_url",
                image_url: {
      ...
      const updatedFile: CompensationUploadedFile = {
        ...
        validation: {
          ...
          photoType: isCompensationForm
            ? "Эмнэлгийн/Эмийн баримт"
            : "Бусад баримт",
          message: isCompensationForm
            ? "Эмнэлгийн эсэх эсвэл эмийн сангийн баримт амжилттай танигдлаа!"
            : "Энэ бол эмнэлгийн эсвэл эмийн сангийн баримт биш байна",
        },
  ...
  return (
    <>
      ...
      <CompensationModal
        ...
        error={error}
        title="Төлбөрийн баримт оруулах"
        description="Төлбөрийн баримтыг оруулж AI-аар шалгах"
...
export default PaymentReceiptAi;
