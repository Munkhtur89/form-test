    ...
    try {
      ...
      const apiRequestBody = {
        ...
        messages: [
          {
            role: "system",
            content: `Энэ бол Монгол улсын онцгой байдлын бичиг баримт. Таны хариулт нь зөвхөн JSON форматтай байх ёстой:

{
  "isValid": boolean,
  "photoType": "гал түймрийн акт" | "шинжээчийн дүгнэлт" | "онцгой байдлын бичиг баримт",
  "message": string,

}

Бичиг баримтын төрлүүд:
- "гал түймрийн акт": Гал түймрийн улсын хяналтын байцаагчийн акт
- "шинжээчийн дүгнэлт": Галын шинжээчийн дүгнэлт
- "ослын акт": Зам тээврийн ослын акт
- "байгалийн гамшгийн акт": Усны гамшгийн, газар хөдлөлтийн акт
- "химийн аюулгүй байдлын тайлан": Химийн бодисын алдагдал, аюулгүй байдлын тайлан
...
`,
          },
          {
            ...
            content: [
              {
                type: "text",
                text: `Энэ зургийг харж, онцгой байдлын бичиг баримтын төрлийг тодорхойлж, чухал мэдээллийг гаргана уу.`,
              },
      ...
      const timeoutId = setTimeout(() => controller.abort(), 15000); // 30 секунд timeout
          ...
          >
            ...
            <div className="text-center">
              <span className="text-blue-700 font-medium text-lg">
                {multiple
                  ? "Онцгой байдалын бичиг баримтууд AI-д таниулна уу"
                  : "Онцгой байдалын бичиг баримт AI-д таниулна уу"}
              </span>
