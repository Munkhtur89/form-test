      ...
      <div className="mb-8 bg-white border border-gray-200 rounded-xl  duration-300">
        <div className="p-4">
          <div className="mt-8 space-y-2 bg-white rounded-xl border border-gray-200 ">
            ...
            <div className="w-full border-2 border-dashed border-blue-200 bg-blue-50 rounded-xl p-8 flex flex-col items-center justify-center  ">
              <svg
              ...
              <input
                ...
                accept="image/*"
                className="sr-only"
                onChange={(e) => handleFileUpload(e, "insuranceContract")}
              />
            </div>

            {/* Uploaded Files UI */}
            {formValues?.insuranceContractPhotos?.length > 0 && (
              <div className="bg-white rounded-xl border border-gray-200 p-4 mt-4">
                <div className="font-semibold text-gray-700 mb-2">
                  Оруулсан файлууд
                </div>
                <div className="space-y-3 max-h-64 overflow-y-auto">
                  {formValues?.insuranceContractPhotos?.map((photo, index) => (
                    <div
                      key={index}
                    ...
                    >
                      <div className="w-12 h-12 rounded-md overflow-hidden mr-4 flex-shrink-0">
                        <Image
                          ...
                          alt={`Insurance contract photo ${index + 1}`}
                          width={48}
                          height={48}
                          ...
                          onClick={() => {
                            setFormValues((prev: FormValues) => ({
                              ...
                              insuranceContractPhotos:
                                prev.insuranceContractPhotos.filter(
